...
container.style.fontSize = "0";
        ...
        // Use a regular anchor wrapping a div with AlphaImageLoader for IE7 PNG support,
        // falling back to a plain img for everything else
        var imgWrapper;
...
imgWrapper.border = "0";
    ...
    var loadAndShow = function() {
        // Only ever show one ad per session
        if (adShown) {
            printDebug("Ad already shown this session, skipping.");
            return;
        }
        // Also bail if an ad div is already in the DOM
