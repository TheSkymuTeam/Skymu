...
namespace Skymu.Skyaeris
{
    public static class Theme
    {
        ...
        public static SolidColorBrush darkBlue = new SolidColorBrush(
            (Color)ColorConverter.ConvertFromString("#1d3a55")
        );
        public static SolidColorBrush white = new SolidColorBrush(
        ...
        {
            public static SolidColorBrush FillPrimary = new SolidColorBrush(
                (Color)ColorConverter.ConvertFromString("#d4e2f2")
            );
            public static SolidColorBrush FillSecondary = new SolidColorBrush(
                (Color)ColorConverter.ConvertFromString("#bfcee0")
            );
        }
    }
}
