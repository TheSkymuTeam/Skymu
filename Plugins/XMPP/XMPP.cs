...
namespace Stub
{
    public class Core : ICore
    {
        ...
        public AuthTypeInfo[] AuthenticationTypes
        {
            get
            {
                return new[] { new AuthTypeInfo(AuthenticationMethod.Password, "JID") };
            }
        }
        ...
        {
            ContactsList.Add(new DirectMessage(new User("Skymu user 1", "u1", "u1", "hi skmuuymu", UserConnectionStatus.Online), 0, "32"));
